...
// DotMatrix component for generating the dot matrix with shaders
...
// ShaderMaterial component to render the custom shader
...
// Shader component that wraps the shader material
